...
* First of all, the entire site now runs from Movable Type - "details here(Power your website with Movable Type)":http://www.mentalized.net/features/movable_type/power_your_website_with_movable_type/ .
...
* Employed "my idea(scrap those pixels)":http://www.mentalized.net/journal/archives/technology/scrap_those_pixels/ for using em's for all widths, creating a fixed-width website that scales with the users preferred font-size.
