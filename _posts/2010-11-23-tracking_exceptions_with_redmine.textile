...
That's what services like "Exceptional":http://getexceptional.com or "Hoptoad":http://hoptoadapp.com solves. Whenever an error occurs in your application the details are sent to their service, where you are able to see when, where and how many times a given error has occurred.
