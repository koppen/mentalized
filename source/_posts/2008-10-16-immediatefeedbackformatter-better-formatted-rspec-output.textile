...
For now, you can get the basic formatter "here":http://mentalized.net/files/rspec/rspec-immediate-feedback-formatter.rb - hopefully it'll sneak into RSpec proper or end up somewhere more accessible (and with tests and whatnot).
