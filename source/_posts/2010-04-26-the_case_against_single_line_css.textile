...
Finding a particular attribute in that list is hard, and it can get really hard to quickly grasp what a rule is doing. For example, this actual rule from "substancelab.com":http://substancelab.com is not all that easy scan, is it?
