...
This idea is great in all its simplicity because SQL Server makes this kind of views updatable. "Jakob", I thought to myself, "you're a genious". Then I ran my tests and errors were everywhere.
