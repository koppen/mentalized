...
Ah, screen sizes, a "pet peeve of mine":http://mentalized.net/journal/2009/02/19/size-still-matters/. The Cooper site seems optimized for a very small range of browser sizes.
...
Disclaimer, I don't know the stats for cooper.com - it might be that all their users use 1024 pixels wide screens and maximize their browser, I don't know. However, it does go against all the statistic I have seen (and "measured":http://mentalized.net/journal/2006/10/24/browser-size-does-matter-actual-numbers/).
