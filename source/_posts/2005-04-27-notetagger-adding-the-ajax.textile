...
I guess it might be possible to create a Rails application, setup a database like "described earlier":http://mentalized.net/journal/2005/04/15/notetagger-getting-down-and-dirty/ and unzip the contents into the app directory to get Notetagger running locally.
