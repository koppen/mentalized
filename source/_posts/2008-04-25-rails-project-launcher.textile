...
It's a modified version of a workflow I found somewhere on the net. Unfortunately I cannot find the original source now, so I cannot even give credit where it's due. "Download it here":https://mentalized.net/files/journal/rails-project-launcher/EditRailsProjectWorkflow.zip.
