...
- programming
---
A long time ago (one day short of exactly 4 years) I posted a super simple - and to be honest - pointless "Hello World example using Ruby on Rails":http://mentalized.net/journal/2006/02/06/hello-ruby-on-rails-world/. Back then the "Rails":http://rubyonrails.org version was 1.0.
