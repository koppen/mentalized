...
* Employed "my idea(scrap those pixels)":https://mentalized.net/journal/archives/technology/scrap_those_pixels/ for using em's for all widths, creating a fixed-width website that scales with the users preferred font-size.
