...
Uhm, huh? The above is from "Rails":http://rubyonrails.org 2.3.5 using "SQLite":http://sqlite.org/, but I originally saw the issue running on "PostgreSQL":http://postgresql.org. 
