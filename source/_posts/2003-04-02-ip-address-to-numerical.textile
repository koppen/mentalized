...
- technology
---
An IPv4 address consists of 4 bytes and is generally represented as A.B.C.D - for example the IP address of mentalized.net is <a href="http://217.116.224.24" title="www.biq.dk">217.116.224.24</a> (note, you can't actually use this IP address to access <a href="/" title="mentalized.net">mentalized.net</a>). This address can also be expressed as the numerical value, <a href="http://3648315416" title="www.biq.dk">3648315416</a>.
