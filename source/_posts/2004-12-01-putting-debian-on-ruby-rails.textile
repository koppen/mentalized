...
Since apt-get won't give us Ruby 1.8.1 and I want to use apt and RubyGems I was stuck at this point for a while, while trying out different workarounds to no avail and becoming "increasingly frustrated(Breaking the Linux Barrier)":http://mentalized.net/journal/2004/11/05/breaking-the-linux-barrier/.
