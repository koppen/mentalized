...
The links need a little love too. "I":http://mentalized.net "like":http://www.guildspace.net "green":http://substancelab.com, so we'll make them green. The hover style needs to highlight the full link, so we create an inverted style for that. Websafe colors all the way.
