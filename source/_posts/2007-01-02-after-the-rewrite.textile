...
- programming
---
"Around 6 months ago":http://mentalized.net/journal/2006/07/11/biq_on_rails_its_a_go/ I started the actual progress of rewriting our existing, customer facing application at "BiQ":http://www.biq.dk.
...
We're hoping to launch before February, I'll be sure to shout it from the roof tops (or at least "mentalized":http://mentalized.net) when we do. I'll see if I can find the time to write a bit more about some of the more technical details of the rewrite as well.
