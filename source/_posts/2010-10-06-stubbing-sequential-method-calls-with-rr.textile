...
However, I am using "RR":http://github.com/btakita/rr and that doesn't provide any syntactic sugar for this. Thankfully, "Laust":http://personal-it.dk showed me a way that is almost as clean:
