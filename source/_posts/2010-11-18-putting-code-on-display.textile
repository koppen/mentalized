...
Sure, I could've created printouts of pages from the many "sites I've built":http://substancelab.com/work, but that' s not really showing off my work. A screenshot is fine for showing the visuals of a website, but that's not what I (usually) do.
