...
We've used "Bort":http://github.com/fudgestudios/bort/ (as I am sure a ton of other teams has as well) as the base for the application, and I am sure we've have saved some time doing just that.
